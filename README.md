...
- **[Mermaid Live Editor](https://mermaid.live/):** Simply copy and paste the generated output into the editor to view and export the diagram as an image (SVG, PNG).
- **VS Code:** Install the [Mermaid Editor](https://marketplace.visualstudio.com/items?itemName=tomoyukim.vscode-mermaid-editor) or [Markdown Mermaid Preview](https://marketplace.visualstudio.com/items?itemName=shanehowell.mermaid-markdown-preview) extension to see live previews directly in your IDE.
